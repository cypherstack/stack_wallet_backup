...
const String _safeLowerCase =
    'abcdefghijkmnpqrstuvwxyz'; // all letters except `l, o`
const String _safeUpperCase =
    'ABCDEFGHJKLMNPQRSTUVWXYZ'; // all letters except 'I, O'
...
int entropyFromLength(int length) {
  return length *
      log(getCharacterSet().length) ~/
      log(2); // log2([size of character set]^[length of password])
}
